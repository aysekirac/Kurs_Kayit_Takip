<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="personel_ekleme.aspx.cs" Inherits="Kurs_Kayit_Takip.Admin.index" %>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-blue-hoki bold uppercase">PERSONEL EKLEME İŞLEMLERİ</span>
                ...
                <div class="portlet-body form">
                    ...
                    <form action="#" class="horizontal-form">
                        <div class="form-body">
                            <h3 class="form-section">PERSONEL BİLGİLERİ</h3>
                            <div class="row">
                                <div class="col-md-6">
